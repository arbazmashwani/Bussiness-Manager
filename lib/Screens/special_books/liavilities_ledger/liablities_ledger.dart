...
class LiabilityLedger extends StatefulWidget {
  const LiabilityLedger({super.key});

  @override
  State<LiabilityLedger> createState() => _LiabilityLedgerState();
}

class _LiabilityLedgerState extends State<LiabilityLedger> {
  ...
  Future<void> getdata() async {
    ...
    filterstocklist = stocklist
        .where((element) =>
            element.acCode.toString().toLowerCase()[0] == "L".toLowerCase())
        .toList();
    searchfilters =
