...
class AssetsLedger extends StatefulWidget {
  const AssetsLedger({super.key});

  @override
  State<AssetsLedger> createState() => _AssetsLedgerState();
}

class _AssetsLedgerState extends State<AssetsLedger> {
  ...
  Future<void> getdata() async {
    ...
    filterstocklist = stocklist
        .where((element) =>
            element.acCode.toString().toLowerCase()[0] == "A".toLowerCase())
        .toList();
    searchfilters =
