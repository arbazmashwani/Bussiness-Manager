...
class PaymentsPageMain extends StatefulWidget {
  const PaymentsPageMain({super.key});

  @override
  State<PaymentsPageMain> createState() => _PaymentsPageMainState();
}

class _PaymentsPageMainState extends State<PaymentsPageMain> {
  ...
  Future<void> getdata() async {
    ...
    accountlistusers = await _service.getpaymentsdata();
                                                  ...
                                                  Expanded(
                                                    ...
                                                    if (credittercontroller
                                                      ...
                                                      final res = await apicall(
                                                          "INSERT INTO Payments (EntryNo, Dated, AcCredited, Particulars, AcDebited, Amount, ConvRate) VALUES ('${Num.toString()}', '$datefilterstring', '${credittercontroller.text}', '${particularcontroller.text}', '${debittercontroller.text}', '${amountcontroller.text}', '1');");
                                                      await apicall(
